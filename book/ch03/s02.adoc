...
To register a client to your {lm} instance, this book assumes you have access to an openSUSE Leap 15.6 instance. In this exercise, the instance hostname is `leap-client.tf.local`.
