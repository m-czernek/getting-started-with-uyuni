...
Salt Bundle::
--
Salt Bundle is a distribution of Salt that is designed to work with {lm}. Salt Bundle, which is the `venv-salt-minion` package, is a Python virtual environment that contains Salt, as well as all of the runtime dependencies to run Salt.
...
Bootstrap Script::
{lm} enables you to generate a shell script that you execute from a client. This is useful when registering a large number of clients automatically.
